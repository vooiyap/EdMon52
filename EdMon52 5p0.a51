...
;========================================================================================
; Monitor jump table
; This is a lookup table containing addresses of subroutines that correspond to specific 
; commands. It allows the program to execute the appropriate function based on user input.
;========================================================================================
jumpTable:
...
;========================================================================================
; checkDPL subroutine
; The routine checks if the Data Pointer Low (DPL) register contains the value 0x10 
; (16 in decimal). The routine temporarily stores the value of DPL, performs a 
; subtraction, and determines if the result is zero. Based on this check, it retains 
; the computed result before returning.
;========================================================================================
...
; The subroutine displays an error message ("bad command") when an invalid command is 
; received and then jumps to endloop for further handling.
; Steven B. Leeb, Massachusetts Institute of Technology
;========================================================================================
badCommand:
			Lcall printString
...
; The subroutine displays an error message ("bad parameter") when an invalid parameter 
; is detected and then jumps to endloop for further handling.
; Steven B. Leeb, Massachusetts Institute of Technology
;========================================================================================
badParameter:
			Lcall printString
...
; The subroutine retrieves a function pointer (jump address) from a jump table based 
; on the command index stored in R2 and executing the corresponding command.
; Steven B. Leeb, Massachusetts Institute of Technology
;========================================================================================
commandSelector:
...
; The subroutine filters control characters and non-printable ASCII characters, replacing 
; them with a '.' (ASCII 0x2E) if necessary. The main goal is to ensure that only 
...
; The subroutine inserts a colon (:) followed by a space ( ) into an output stream by 
; calling the sendCharacter subroutine twice.
;========================================================================================
addColon:   
			Mov A,#":"
		    ACall sendCharacter
...
; The subroutine sends a carriage return (CR, 0x0D) and a line feed (LF, 0x0A) 
