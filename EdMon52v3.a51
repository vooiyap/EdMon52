...
; It also display a menu of the available commands.
...
Start:						   	   ; stalls at 2nd row of data displayed. 
			...
			DB "EdMon52 2.0", 0x00
			Acall   printString    ; print welcome message
			DB 0x0A, 0x0D, "Commands: ", 0x00
			Acall   printString    ; print welcome message
			DB 0x0A, 0x0D, "C <aaaa> <dd> - Change contents of external memory ", 0x00
			Acall   printString    ; print welcome message
			DB 0x0A, 0x0D, "G <aaaa>      - Go (execute program) ", 0x00
			Acall   printString    ; print welcome message
			DB 0x0A, 0x0D, "M <aaaa>      - Display contents of code memory ", 0x00	
			Acall   printString    ; print welcome message
			DB 0x0A, 0x0D, "R             - Dump registers ", 0x00				
